...
# Load libraries ----------------------------------------------------------
require(pacman)
p_load(ggplot2, tidyverse, readxl, WDI, xlsx, FAOSTAT)
...
agrc <- read_csv('https://raw.githubusercontent.com/fabiolexcastro/tutorials_youtube/master/worldData/downloaded/API_AG.LND.AGRI.ZS_DS2_en_csv_v2_4669757/API_AG.LND.AGRI.ZS_DS2_en_csv_v2_4669757.csv', skip = 4)
...
food <- read_csv('https://raw.githubusercontent.com/fabiolexcastro/tutorials_youtube/master/worldData/downloaded/FAOSTAT_data_en_11-25-2022.csv')
colnames(food)[3] <- 'ISO'
...
tble <- tble %>% dplyr::rename(agricultural_land = value)
...
dfrs <- read_csv('https://raw.githubusercontent.com/fabiolexcastro/tutorials_youtube/master/worldData/downloaded/P%C3%A9rdida%20mundial%20de%20bosques%20primarios/treecover_loss__ha.csv')
dfrs <- dfrs[,1:3]
